...
linguagem de forma conceitual; a Seção 5 a formaliza a gramática
...
Os escopos são organizados em uma pilha que reflete a
...
Python, já no formato da plataforma. Um \texttt{id} é gerado, caso não tenha sido especificado. Em seguida, o modelo é
